...
This section will give a very brief overview of AES and, most importantly, emphasize the synthesis challenges presented by each stage of the encryption process. Additionally, this section will briefly explain what it means to operate AES in Counter Mode.
\section{Methodology}
...
A design process cannot claim to operate at a level of abstraction higher than the lowest layer presented to the designer.
